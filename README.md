...
History Map — веб-приложение, предназначенное для визуализации и моделирования исторических связей между людьми, событиями, произведениями искусства, документами и другими объектами.

Приложение представляет собой интерактивную карту, на которой пользователь может размещать карточки сущностей и создавать связи между ними. Таким образом формируется граф знаний, позволяющий визуально исследовать взаимосвязи между различными элементами истории.

Основная идея проекта — предоставить инструмент, позволяющий структурировать историческую информацию и находить связи между различными объектами.

В отличие от энциклопедий и вики-проектов, система ориентирована на визуальную модель представления информации, где знания представлены в виде сети связанных сущностей.
...
- [ ] Разработать модель веб-приложения (backend)
